// Import inquirer, printTable and mysql
...
function updateEmployeeRole() {
    inquirer.prompt([
        ...
        {
            type: 'input',
            message: 'enter exist employee id',
            name: 'employee_id',
        }])
        .then(data => {
            // So, in this table structure, the id column acts as the employee_id. 
            // When referencing employees in other tables (for instance, when specifying a manager for an employee), 
            // the id column from the employee table is used.
...
function deleteDepartment() {
    ...
    inquirer.prompt({
        type: 'input',
        message: 'choose what  department you want to delete\n \n',
        name: 'delete',
    })
        .then(data => {
            db.query('DELETE FROM department WHERE id = ?', [data.delete], (err) => {
                if (err) {
                    console.log(err);
                }
            })
...
// function to exit the appication
function exitApp() {
